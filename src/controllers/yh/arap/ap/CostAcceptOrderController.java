...
public class CostAcceptOrderController extends Controller {
    ...
    public void list() {
        ...
        String spName = getPara("sp")!=null?getPara("sp").trim():"";
        ...
        String orderType = getPara("orderType")!=null?getPara("orderType").trim():"";
        String status2 = "";
        String status3 = "";
        String status4 = "";
        String status5 = "";
    ...
    public void applicationList() {
        ...
        String beginTime = getPara("beginTime")!=null?getPara("beginTime").trim():"";
        String endTime = getPara("endTime")!=null?getPara("endTime").trim():"";
        String applicationOrderNo = getPara("applicationOrderNo")!=null?getPara("applicationOrderNo").trim():"";
        String orderNo = getPara("orderNo")!=null?getPara("orderNo").trim():"";
        String status = getPara("status")!=null?getPara("status").trim():"";
        String check_begin_time = getPara("check_begin_date")!=null?getPara("check_begin_date").trim():"";
        String check_end_time = getPara("check_end_date")!=null?getPara("check_end_date").trim():"";
