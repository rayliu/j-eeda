...
public class WeixinMsgController extends MsgController {
	...
	protected void processInTextMsg(InTextMsg inTextMsg) {
		...
		else if ("demo".equalsIgnoreCase(msgContent)) {
			OutTextMsg outMsg = new OutTextMsg(inTextMsg);
			outMsg.setContent("\t文本消息已成功接收，内容为： " + inTextMsg.getContent() + "\n\n\n" + "<a href='"+url+"/demo'>请点我跳转到demo页面</a>");
			render(outMsg);
		}
		...
		else if ("配送签收".equalsIgnoreCase(msgContent)) {
			OutTextMsg outMsg = new OutTextMsg(inTextMsg);
			outMsg.setContent("\t文本消息已成功接收，内容为： " + inTextMsg.getContent() + "\n\n\n" + "<a href='"+url+"/distribution'>请点我跳转到回单签收页面</a>");
			render(outMsg);
		}
		else if ("直送签收".equalsIgnoreCase(msgContent)) {
			OutTextMsg outMsg = new OutTextMsg(inTextMsg);
			outMsg.setContent("\t文本消息已成功接收，内容为： " + inTextMsg.getContent() + "\n\n\n" + "<a href='"+url+"/directSend'>请点我跳转到回单签收页面</a>");
			render(outMsg);
		}
		// 图文消息测试
