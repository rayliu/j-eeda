...
public class ProfileDataInit {
    public static void initProfile(Statement stmt) {
        try {
            ...
            // 供应商信息                                                                                              
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, phone, ADDRESS, SP_TYPE) values('示例干线供应商---海南城市之星物流有限公司','示例line供应商---海南城市之星物流有限公司','邓孚任','330000','海南省海口市海口农商银行','','18608903177','海口市龙昆南路56号龙泉家园C栋2103房','line');");
