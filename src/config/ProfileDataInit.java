...
public class ProfileDataInit {
    public static void initProfile(Statement stmt) {
        try {
            ...
            // 供应商信息
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('海南城市之星物流有限公司','海南城市之星物流有限公司','邓孚任','330000','海南省海口市海口农商银行','','18608903177','海口市龙昆南路56号龙泉家园C栋2103房','干线');");
            ...
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('广州市其辉物流有限公司（原4部）','广州市其辉物流有限公司','小林','330000','工商银行 广州市环城支行','','87434270','白云区沙太路林安物流园十街1009-1023档','干线');");
            ...
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('海南城市之星物流有限公司','海南城市之星物流有限公司','邓孚任','460000','海南省海口市海口农商银行','','18608903177','广州市白云区石井镇鸦岗大道锦亿物流中心A34-35档','配送');");
            ...
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('济南骏运展达物流运输有限公司','济南骏运展达物流运输有限公司','李骏含','370000','山东省齐鲁银行蓝翔路支行','','13181709281','济南市天桥区蓝翔路7号','配送');");
