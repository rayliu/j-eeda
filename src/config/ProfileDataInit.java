...
public class ProfileDataInit {
    public static void initProfile(Statement stmt) {
        try {
            ...
            // 供应商信息
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('示例干线供应商---海南城市之星物流有限公司','示例干线供应商---海南城市之星物流有限公司','邓孚任','330000','海南省海口市海口农商银行','','18608903177','海口市龙昆南路56号龙泉家园C栋2103房','干线');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('浙江淇辉物流有限公司','浙江淇辉物流有限公司','谢经理','440100','工商银行 广州市环城支行','','37417190','白云区沙太路林安物流园十街1001-1008档','干线');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('示例提货供应商---广州市其辉物流有限公司（原4部）','示例提货供应商---广州市其辉物流有限公司','小林','330000','工商银行 广州市环城支行','','87434270','白云区沙太路林安物流园十街1009-1023档','干线');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('济南世纪顺通运输有限公司','济南世纪顺通运输有限公司','小潇','440100','中国工行太和分行','','020-87439061','白云区太和镇白云货运市场A4区17、18档','干线');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('广东盛丰物流有限公司','广东盛丰物流有限公司','刘经理','440100','中国工商银行  佛山市南海金沙湾支行','','13560012022','白云区太和镇大源北路，林安物流园六街西面21-22档','干线');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('广州市贵腾物流有限公司','广州市贵腾物流有限公司','','440100','中国银行 广州东风中路支行','','62192677','沙太北路丰和南场D5栋009-011档','干线');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('海南城市之星物流有限公司（广州分公司）','海南城市之星物流有限公司（广州分公司）','邓孚任','460000','海南省海口市海口农商银行','','18608903177','广州市白云区石井镇鸦岗大道锦亿物流中心A34-35档','配送');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('杭州汉唐货运有限公司','杭州汉唐货运有限公司','小潘','330000','建行天水支行（浙江省杭州市）','','18268803197','杭州市江干区杭海路189号','配送');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('天地货运','天地货运','毛伟刚','330000','建行天水支行（浙江省杭州市）','','13806507826','宁波市石碶街道雍景苑小区25幢602室','配送');");
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, MOBILE, ADDRESS, SP_TYPE) values('示例配送供应商---济南骏运展达物流运输有限公司','济南骏运展达物流运输有限公司','李骏含','370000','山东省齐鲁银行蓝翔路支行','','13181709281','济南市天桥区蓝翔路7号','配送');");
