...
public class ProfileDataInit {
    public static void initProfile(Statement stmt) {
        try {
            ...
            stmt.executeUpdate("insert into contact(COMPANY_NAME, ABBR, CONTACT_PERSON, LOCATION, INTRODUCTION, EMAIL, phone, ADDRESS, SP_TYPE) values('海南城市之星物流有限公司（广州分公司）','海南城市之星物流有限公司（广州分公司）','邓孚任','460000','海南省海口市海口农商银行','','18608903177','广州市白云区石井镇鸦岗大道锦亿物流中心A34-35档','配送');");
