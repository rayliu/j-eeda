...
public class DataInitUtil {
    public static void initH2Tables(C3p0Plugin cp) {
        try {
            ...
            stmt.executeUpdate("create table if not exists user_login(id bigint auto_increment primary key, user_name varchar(50) not null, password varchar(50) not null, password_hint varchar(255), office_id bigint, token varchar(10),c_name varchar(50),is_stop boolean, foreign key(office_id) references office(id));");
            ...
            // product 产品
            stmt.executeUpdate("create table if not exists product(id bigint auto_increment primary key,item_name varchar(50),item_no varchar(255),serial_no varchar(255),size double,width double,height double,unit varchar(255),volume double,weight double,item_desc varchar(5120),category_id bigint,insurance_amount double,foreign key(category_id) references category(id));");
