...
public class DataInitUtil {
    public static void initH2Tables(C3p0Plugin cp) {
        try {
            ...
            stmt.executeUpdate("create table if not exists office(id bigint auto_increment PRIMARY KEY, office_code VARCHAR(50) not null, office_name VARCHAR(50), contact_id VARCHAR(255),company_person varchar(50),address varchar(255),type varchar(50),remark varchar(255));");
    ...
    public static void initData(C3p0Plugin cp) {
        try {
            ...
            stmt.executeUpdate("insert into office(office_code, office_name, company_person,contact_id,address,type,remark) values('1201', '广州司','张三', '020-1122211','广东省珠海市香洲区老香洲为农街为农市场','自营','');");
            stmt.executeUpdate("insert into office(office_code, office_name, company_person,contact_id,address,type,remark) values('121', '珠公司', '李四','0756-1113333','广东省珠海市香洲区老香洲为农街为农市场','控股','');");
            stmt.executeUpdate("insert into office(office_code, office_name, company_person,contact_id,address,type,remark) values('101', '深圳分公司','王五', '0751-11111111','广东省珠海市香洲区老香洲为农街为农市场','合作','');");
            ...
            // 运输单
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,route_id,address) values('ATM', '6', '9', '2014042600003', '3', '干线供应商自提', '5', '订单已生成', '2014-04-26 16:33:35.1', '货品直送','1','珠海');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,route_id,address) values('普通货品 ', '7', '10', '2014042600003', '4', '公司自提', '4', '订单已生成', '2014-04-26 16:40:35.1', '入中转仓','2','中山');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,address) values('普通货品 ', '7', '9', '2014042600003', '4', '公司自提', '5', '新建', '2014-04-26 16:40:35.1', '入中转仓','广州');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,address) values('普通货品', '6', '10', '2014042600004', '3', '干线供应商自提', '4', '新建', '2014-04-26 16:35:35.1', '入中转仓','深圳');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,address) values('ATM', '7', '9', '2014042600005', '3', '干线供应商自提', '5', '新建', '2014-04-26 16:38:35.1', '货品直送','东莞');");
            // 货品明细
