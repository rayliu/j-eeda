...
public class DataInitUtil {
    public static void initH2Tables(C3p0Plugin cp) {
        try {
            ...
            stmt.executeUpdate("create table if not exists pickup_record(id bigint auto_increment primary key, pickup_id bigint, driver varchar(50), phone varchar(50),car_no varchar(50), car_type varchar(50),car_follow_name varchar(50),car_follow_phone varchar(50),length double);");
            // party 当事人，可以有各种type
            stmt.executeUpdate("create table if not exists party(id bigint auto_increment primary key, party_type varchar(32), contact_id bigint,license varchar(20), create_date timestamp, creator varchar(50), last_update_date timestamp, last_updator varchar(50), status varchar(50),remark varchar(255),receipt varchar(50),payment varchar(50));");
    ...
    public static void initData(C3p0Plugin cp) {
        try {
            ...
            stmt.executeUpdate("insert into transfer_order(cargo_nature, sp_id, notify_party_id, order_no, create_by, customer_id, status, create_stamp, arrival_mode,address,route_from,route_to,office_id,order_type,customer_province,pickup_seq,operation_type) values('cargo', '8', '13', 'YS2014042600004', '3', '1', '新建', '2014-04-25 16:35:35.1', 'gateIn','深圳','110107','440404','1','replenishmentOrder','provinceIn','3','own');");
            ...
            stmt.executeUpdate("insert into transfer_order(cargo_nature, sp_id, notify_party_id, order_no, create_by, customer_id, status, create_stamp, arrival_mode,address,route_from,route_to,warehouse_id,office_id,order_type,customer_province,operation_type) values('ATM', '9', '13', 'YS2014042600006', '3', '3', '新建', '2014-04-24 16:58:35.1', 'gateIn','东莞','110109','440511','2','2','arrangementOrder','provinceIn','out_source');");
    ...
    public static void newCustomer() {
        ...
        contact7.set("company_name", "珠海博兆计算机科技有限公司").set("contact_person", "温生").set("email", "test@test.com")
                .set("abbr", "珠海博兆");
        contact7.set("mobile", "12345671").set("phone", "113527229313").set("address", "香洲珠海市香洲区老香洲为农街为农市场1")
        ...
        contact5.set("mobile", "12345674").set("phone", "413527229313").set("address", "香洲珠海市香洲区老香洲为农街为农市场4")
        ...
        p7.set("contact_id", contact7.getLong("id")).set("party_type", "CUSTOMER").set("create_date", createDate)
                .set("creator", "demo").set("payment", "freightCollect").save();
        p2.set("contact_id", contact2.getLong("id")).set("party_type", "CUSTOMER").set("create_date", createDate)
                .set("creator", "demo").set("payment", "cashPayment").save();
        p3.set("contact_id", contact3.getLong("id")).set("party_type", "SERVICE_PROVIDER")
                .set("create_date", createDate).set("payment", "demo").save();
        p4.set("contact_id", contact4.getLong("id")).set("party_type", "SERVICE_PROVIDER")
