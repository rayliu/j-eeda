...
public class DataInitUtil {
    ...
    public static void initData(C3p0Plugin cp) {
        try {
            ...
            stmt.execute("insert into product(item_name,item_no,size,width,height,weight,category_id,item_desc) values('特殊货品', '2014042600003','1100','5300','7400', 30, 2, '这是特殊货品');");
