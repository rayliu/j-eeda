...
public class DataInitUtil {
	...
	public static void initData(C3p0Plugin cp) {
		try {
			...
			stmt.executeUpdate("insert into return_order(order_no,create_date,transaction_status,order_type,creator,remark,transfer_order_id, delivery_order_id, notity_party_id,customer_id,route_from,route_to) values('回单20132014001', CURRENT_TIMESTAMP(), 'new','应收','张三','这是一张回单','1', 1, '1','4','110102','440402');");
			stmt.executeUpdate("insert into return_order(order_no,create_date,transaction_status,order_type,creator,remark,transfer_order_id, notity_party_id,customer_id,route_from,route_to) values('回单20132014002', CURRENT_TIMESTAMP(), 'confirmed','应收','张三','这是一张回单','2', '2','4','	110105','442000');");
