...
public class DataInitUtil {
    public static void initH2Tables(C3p0Plugin cp) {
        try {
            ...
            stmt.executeUpdate("create table if not exists contract_item(id bigint auto_increment primary key,product_id bigint,contract_id bigint,fin_item_id bigint,pricetype varchar(50),cartype varchar(255),carlength varchar(255),load varchar(50),ltlunittype varchar(50), from_id varchar(50),location_from varchar(50),to_id varchar(50),location_to varchar(50) ,amount double,remark varchar(255),unit varchar(20),dayFrom varchar(50),dayTo varchar(50),amountFrom double,amountTo double,kilometer varchar(50));");
            ...
            stmt.executeUpdate("create table if not exists transfer_order(id bigint auto_increment primary key,order_no varchar(255),customer_order_no varchar(255),status varchar(255),pickup_assign_status varchar(255),depart_assign_status varchar(255),"
                    + "cargo_nature varchar(255),cargo_nature_detail varchar(255),inventory_id bigint,pickup_mode varchar(255),arrival_mode varchar(255),charge_type varchar(50),charge_type2 varchar(50),receiving_unit varchar(255),remark varchar(255),operation_type varchar(255),pickup_seq varchar(255),payment varchar(50),car_size varchar(255),car_no varchar(255),car_type varchar(255),create_by bigint,"
            ...
            stmt.executeUpdate("create table if not exists arap_cost_invoice_application_order(id bigint auto_increment primary key,order_no varchar(255),status varchar(255),payment_method varchar(255),create_by bigint,create_stamp timestamp,audit_by bigint,audit_stamp timestamp,approver_by bigint,"
            		+ " approval_stamp timestamp,last_modified_by bigint,last_modified_stamp timestamp,remark varchar(5120),payee_id bigint,account_id bigint,foreign key(account_id) references fin_account(id));");
            stmt.executeUpdate("create table if not exists arap_cost_order(id bigint auto_increment primary key,order_no varchar(255),order_type varchar(255),status varchar(255),amount double,payee_id varchar(255),create_by bigint,confirm_by bigint,begin_time timestamp,end_time timestamp,"
            ...
            stmt.executeUpdate("create table if not exists arap_cost_invoice_item_invoice_no(id bigint auto_increment primary key,invoice_no varchar(255),amount double,invoice_id bigint,foreign key(invoice_id) references arap_cost_invoice_application_order(id));");
