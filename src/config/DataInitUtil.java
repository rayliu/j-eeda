...
public class DataInitUtil {
    ...
    public static void initData(C3p0Plugin cp) {
        try {
            ...
            // 运输单
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,route_id) values('ATM', '6', '9', '2014042600003', '3', '干线供应商自提', '4', '订单已生成', '2014-04-26 16:33:35.1', '货品直送','1');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,route_id) values('普通货品 ', '7', '10', '2014042600003', '4', '公司自提', '5', '订单已生成', '2014-04-26 16:40:35.1', '入中转仓','2');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE) values('普通货品 ', '7', '9', '2014042600003', '4', '公司自提', '5', '新建', '2014-04-26 16:40:35.1', '入中转仓');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE) values('普通货品', '6', '10', '2014042600004', '3', '干线供应商自提', '4', '新建', '2014-04-26 16:35:35.1', '入中转仓');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE) values('ATM', '7', '9', '2014042600005', '3', '干线供应商自提', '5', '新建', '2014-04-26 16:38:35.1', '货品直送');");
            // 货品明细
    ...
    public static void newCustomer() {
        ...
        contact.set("company_name", "珠海制药科技有限公司").set("contact_person", "张生")
                .set("email", "123123@test.com");
        contact.set("mobile", "18219011111").set("phone", "0756-888888")
        ...
        contact5.set("company_name", "天津佛纳甘科技有限公司")
                .set("contact_person", "何生1").set("email", "test@test.com");
        contact5.set("mobile", "12345674").set("phone", "413527229313")
                .set("address", "香洲珠海市香洲区老香洲为农街为农市场4")
                .set("postal_code", "5190004").save();
        Contact contact6 = new Contact();
        contact6.set("company_name", "天津佛纳甘科技有限公司")
                .set("contact_person", "何生2").set("email", "test@test.com");
