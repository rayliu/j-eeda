...
public class DataInitUtil {
    ...
    public static void initData(C3p0Plugin cp) {
        try {
            ...
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,address,ROUTE_FROM,ROUTE_TO,WAREHOUSE_ID,office_id,order_type) values('ATM', '7', '9', 'YS2014042600006', '3', 'own', '5', '已发车', '2014-04-24 16:58:35.1', 'gateIn','东莞','110109','440511','2','2','arrangementOrder');");
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,address,ROUTE_FROM,ROUTE_TO,WAREHOUSE_ID,office_id,order_type) values('ATM', '7', '9', 'YS2014042600007', '3', 'own', '5', '已入库', '2014-04-24 16:58:35.1', 'gateIn','广州','110112','440512','1','3','arrangementOrder');");
            // 货品明细
