...
public class DataInitUtil {
    ...
    public static void initData(C3p0Plugin cp) {
        try {
            ...
            // 运输单
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,route_id,address) values('ATM', '8', '9', '2014042600001', '3', 'routeSP', '5', '新建', '2014-04-26 16:33:35.1', 'delivery','1','珠海');");
            ...
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,address) values('cargo', '8', '10', '2014042600004', '3', 'own', '4', '已发车', '2014-04-26 16:35:35.1', 'gateIn','深圳');");
            ...
            stmt.executeUpdate("insert into transfer_order(CARGO_NATURE, SP_ID, NOTIFY_PARTY_ID, ORDER_NO, CREATE_BY, PICKUP_MODE, CUSTOMER_ID, STATUS, CREATE_STAMP, ARRIVAL_MODE,address) values('ATM', '7', '9', '2014042600006', '3', 'own', '5', '已发车', '2014-04-26 16:38:35.1', 'gateIn','东莞');");
            // 货品明细
