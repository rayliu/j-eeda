    ...
    <div class="col-lg-4">
        <div class="form-group">
            <div id="{{id}}_begin_div" class="input-date">
                ...
                <input id="{{id}}_begin_time" name="{{id}}_begin_time" class="form-control search-control date" type="text" value="">
                <span class="add-on"> 
                	<i class="fa fa-calendar" data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                </span>
            </div> ~
            <div id="{{id}}_end_div" class="input-date">
                <input id="{{id}}_end_time" name="{{id}}_end_time" class="form-control search-control date" type="text" value="">
                <span class="add-on"> 
                    <i class="fa fa-calendar" data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                </span>
            </div>
