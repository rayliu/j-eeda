...
$(document).ready(function() {
	...
	//datatable, 动态处理
	var uncheckedCostPreInvoiceOrderTable=$('#uncheckedCostPreInvoiceOrder-table').dataTable({
    ...
    var ids = [];
    // 未选中列表
	$("#uncheckedCostPreInvoiceOrder-table").on('click', '.checkedOrUnchecked', function(e){
		if($(this).prop("checked") == true){
			$(this).parent().parent().appendTo($("#checkedCostPreInvoiceOrderList"));
			ids.push($(this).val());
	...
	// 已选中列表
	$("#checkedCostPreInvoiceOrder-table").on('click', '.checkedOrUnchecked', function(e){
		if($(this).prop("checked") == false){
			$(this).parent().parent().appendTo($("#uncheckedCostPreInvoiceOrderList"));
			if(ids.length != 0){
    ...
    $('#companyList').on('click', '.fromLocationItem', function(e){        
        ...
        if(inputStr!=null){
        	...
        	costCheckTable.fnSettings().sAjaxSource = "/yh/costCheckOrder/createList?companyName="+inputStr;
