...
$(document).ready(function() {
    ...
    var costInvoiceOrderListTable = $('#costInvoiceOrderList-table').dataTable({
        ...
        "sAjaxSource": "/yh/costInvoiceOrder/list",
        "aoColumns": [   
            {"mDataProp":"ORDER_NO",
            	"fnRender": function(obj) {
        			return "<a href='/yh/costInvoiceOrder/edit?id="+obj.aData.ID+"'>"+obj.aData.ORDER_NO+"</a>";
        	}},
            {"mDataProp":"STATUS",
                "fnRender": function(obj) {
